...
<body>
	...
	<div class="container mt-3 col-lg-8 col-md-6">
		<h2 class="d-flex justify-content-center text-center text-danger">ERRO AO CADASTRAR NO BANCO DE DADOS</h2>
		<div class="col text-center">
			<a href="#" role="button" class="btn btn-secondary mr-3" onclick="goBack()">Voltar</a>		
			<a href="index.jsp" role="button" class="btn btn-info mr-3">Tela Inicial</a>
		</div>
	</div>
